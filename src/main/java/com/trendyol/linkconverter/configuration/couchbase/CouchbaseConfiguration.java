package com.trendyol.linkconverter.configuration.couchbase;
...
public class CouchbaseConfiguration {
    ...
    @Bean
    public Collection linkLogCollection(Cluster couchbaseCluster) {
        couchbaseCluster.bucket(couchbaseProperties.getBucketName()).waitUntilReady(Duration.ofSeconds(10));
